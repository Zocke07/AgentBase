...
The 0.4.3 downloads are a Windows x64 installer and a macOS Apple Silicon disk
image. Python, Node and Rust are bundled or unnecessary for installed users.
Use the [0.4.3 release](https://github.com/Zocke07/AgentBase/releases/tag/v0.4.3)
or the matching artifact from a successful
[build run](https://github.com/Zocke07/AgentBase/actions/workflows/build.yml).
See the [release notes](../releases/0.4.3.md) for release status and limitations.

### Windows

1. Download `AgentSpace_0.4.3_x64-setup.exe` for an x64 Windows PC.
...
1. Download `AgentSpace_0.4.3_aarch64.dmg` for an Apple Silicon Mac. This
