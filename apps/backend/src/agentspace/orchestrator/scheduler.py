...
launching what is due through :class:`~agentspace.orchestrator.launcher.RunLauncher`,
...
if TYPE_CHECKING:
    ...
    from agentspace.store.schedules import Schedule, ScheduleStore

__all__ = ["DEFAULT_POLL_SECONDS", "Fired", "Scheduler"]

logger = logging.getLogger("agentspace.scheduler")
