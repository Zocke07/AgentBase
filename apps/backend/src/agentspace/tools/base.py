...
class Tool(Protocol):
    ...
    @property
    def name(self) -> str:
        """Matches a :data:`~agentspace.tools.catalogue.CATALOGUE` entry; a test pins the two
        lists.
        """
    ...
    def prepare(self, arguments: dict[str, Any], sandbox: Sandbox) -> Prepared:
        ...
        :raises agentspace.tools.sandbox.SandboxViolationError: out of bounds.
            Becomes `tool.denied`.
        :raises agentspace.tools.sandbox.UrlNotAllowedError: likewise, for a URL.
        """
