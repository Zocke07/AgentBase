...
from agentbase.api.agents import router as agents_router
from agentbase.api.approvals import router as approvals_router
from agentbase.api.auth import router as auth_router
from agentbase.api.channels import router as channels_router
from agentbase.api.knowledge import router as knowledge_router
from agentbase.api.runs import router as runs_router
from agentbase.api.schedules import router as schedules_router
from agentbase.api.settings import router as settings_router
from agentbase.api.spaces import router as spaces_router
from agentbase.budget.ledger import BudgetLedger
from agentbase.channels.service import ChannelDeps, ChannelService
from agentbase.config import (
    ALLOWED_ORIGINS,
    BIND_HOST,
    DEFAULT_BIND_PORT,
    AppPaths,
...
from agentbase.orchestrator.scheduler import Scheduler
from agentbase.providers.chatgpt import ChatGPTRuntime, CodexAppServerRuntime
from agentbase.providers.codex_runtime import CodexRuntimeInstaller
from agentbase.secrets import SecretStore, parse_secrets_line
from agentbase.store.agents import AgentDefStore
from agentbase.store.db import Database
from agentbase.store.schedules import ScheduleStore
...
PORT_ENV_VAR: Final[str] = "AGENTBASE_PORT"
...
INSTANCE_ENV_VAR: Final[str] = "AGENTBASE_INSTANCE"
...
def create_app(
    ...
    :param paths: explicit data locations. Omitted, the directory is resolved
        the way the shipped app resolves it: ``AGENTBASE_DATA_DIR``, then the
        OS app-data dir.
