...
from agentbase.channels.base import ChannelName, InboundMessage
from agentbase.channels.render import DISCORD_MESSAGE_LIMIT
from agentbase.channels.service import converse
from agentbase.tools.approval import ApprovalNotPendingError

if TYPE_CHECKING:
    from collections.abc import Callable

    from agentbase.channels.service import ChannelDeps

__all__ = ["INTENTS", "DiscordAdapter"]

logger = logging.getLogger("agentbase.channels.discord")
...
class _ApprovalView(discord.ui.View):
    ...
    :meth:`~agentbase.tools.approval.ApprovalService.resolve` as
